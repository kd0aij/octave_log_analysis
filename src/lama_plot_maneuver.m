function plot_maneuver(startTime, endTime, data,
  mnum=0, label='untitled', origin=[40.06403056 -104.9204722 1536], 
  rTol=15, posIndex=21, rhdg=75.68, pThresh=88, plotTitle='')
...
# if those are in error, set posIndex to 21 to fall back to GPS samples
